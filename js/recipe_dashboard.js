    ...
    const recipeHTML = `
        <div class="child" data-id="${recipe.id}">
          <div class="icon_child">
            <img src="../assets/icon/icon_child_recip.svg" alt="icon" />
          ...
          <div class="content_child">
            <div class="title_content">
              ...
              <div class="heart">
                <span>
                  <img src="../assets/icon/icon_heart.svg" alt="heart" />
                  37
                </span>
              </div>
            </div>
            ...
            <div class="icon_content">
              <img src="../assets/icon/icon_content_recip.svg" alt="icon" />
            ...
            <div class="specifications">
              <table>
                ...
                <tr>
                  <td>100g</td>
                  <td>${recipe.macronutrients.energy} kcal</td>
                  <td>${recipe.macronutrients.fat} g</td>
                  <td>${recipe.macronutrients.carbohydrate} g</td>
                  <td>${recipe.macronutrients.protein} g</td>
                </tr>
              </table>
            </div>
          </div>
...
const getUniqueCategories = (recipes) => {
  ...
  recipes.forEach((recipe) => {
    recipe.category.forEach((cat) => categorySet.add(cat.name));
  });
...
if (add) {
  add.addEventListener("click", () => {
    window.location.href = "../page/add_recipe.html";
  });
}
